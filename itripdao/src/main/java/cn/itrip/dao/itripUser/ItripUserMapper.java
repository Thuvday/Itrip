...
public interface ItripUserMapper {
	...
	public ItripUser dologin(@Param(value = "name") String name, @Param(value = "password") String password)throws Exception;
	...
	public Integer upActived(@Param(value = "userCode") String userCode) throws Exception;
}
